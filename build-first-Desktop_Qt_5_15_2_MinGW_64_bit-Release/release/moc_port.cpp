...
QT_MOC_LITERAL(1, 5, 13), // "NewDataToRead"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11), // "QByteArray*"
QT_MOC_LITERAL(4, 32, 4), // "data"
QT_MOC_LITERAL(5, 37, 14) // "OnDataReceived"

    },
    "Port\0NewDataToRead\0\0QByteArray*\0data\0"
    "OnDataReceived"
};
...
void Port::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->NewDataToRead((*reinterpret_cast< QByteArray*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Port::*)(QByteArray * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Port::NewDataToRead)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Port::NewDataToRead(QByteArray * _t1)
{
