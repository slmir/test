/********************************************************************************
** Form generated from reading UI file 'Recieve_mode.ui'
**
...
#ifndef UI_RECIEVE_MODE_H
#define UI_RECIEVE_MODE_H
...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        Soglsie_to_recieve_file_button->setGeometry(QRect(30, 310, 391, 28));
        groupBox = new QGroupBox(Dialog);
        groupBox->setObjectName(QString::fromUtf8("groupBox"));
        groupBox->setGeometry(QRect(20, 370, 501, 61));
        progressBar = new QProgressBar(groupBox);
        progressBar->setObjectName(QString::fromUtf8("progressBar"));
        progressBar->setGeometry(QRect(10, 20, 471, 21));
        progressBar->setValue(24);
        Connect_groupBox = new QGroupBox(Dialog);
        Connect_groupBox->setObjectName(QString::fromUtf8("Connect_groupBox"));
        Connect_groupBox->setGeometry(QRect(30, 60, 741, 231));
        ...
        objectName = new QPushButton(frame_3);
