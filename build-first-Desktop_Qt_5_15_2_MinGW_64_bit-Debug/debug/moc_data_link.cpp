...
QT_MOC_LITERAL(4, 41, 18), // "ControlFrameSignal"
QT_MOC_LITERAL(5, 60, 15), // "OnNewDataToRead"
QT_MOC_LITERAL(6, 76, 11), // "QByteArray*"
QT_MOC_LITERAL(7, 88, 4) // "data"

    },
    "DataLink\0DataRead\0\0ConnectionEstablished\0"
    "ControlFrameSignal\0OnNewDataToRead\0"
    "QByteArray*\0data"
};
...
void DataLink::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->ControlFrameSignal(); break;
        ...
        {
            using _t = void (DataLink::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataLink::ControlFrameSignal)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void DataLink::ControlFrameSignal()
{
